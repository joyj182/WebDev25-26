...
Notes:
1) Give each info card a class of "card".
2) Images
...
3) Create an appropriate random price to display for each pizza($15-$35). No HTML element needed
4) Enter quantity is a text input. No need to give it id.
...
function init(){
   ...
   for(i=1; i<=5; i+=1){
      let  p =  Math.floor(Math.random() * (35 - 15 +1) + 15);
